                  ...
                  <TableRow key={staff._id} className="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border-slate-50 dark:border-slate-800">
                    ...
                    <TableCell className="text-right pr-8">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" side="bottom" sideOffset={8} avoidCollisions={false} className="w-48 rounded-2xl p-2 border-none shadow-xl bg-white dark:bg-slate-900 font-sans">
                          <DropdownMenuItem
