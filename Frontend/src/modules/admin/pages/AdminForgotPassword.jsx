        ...
        <div className="min-h-screen flex flex-col md:flex-row bg-white dark:bg-slate-950 font-sans">
            ...
            <div className="hidden md:flex md:w-1/2 bg-slate-900 relative items-center justify-center p-12 overflow-hidden">
                ...
                <div className="relative z-10 text-white space-y-6 max-w-md">
                    ...
                    <p className="text-slate-400 text-lg">Follow the encrypted recovery protocol to restore your administrator access safely.</p>
                </div>
            </div>
                        ...
                        <CardContent className="pt-10 pb-10 px-6 space-y-6">
                                ...
                                {step === 3 && (
                                    ...
                                    >
                                        ...
                                        <Button
                                            ...
                                            className="w-full h-11 text-base font-black bg-slate-900 hover:bg-slate-800 text-white rounded-lg shadow-lg"
                                        >
                                            Return to Login
                                        </Button>
                                    </motion.div>
                            ...
                            {step !== 3 && (
                                <div className="text-center pt-2 border-t border-slate-100 flex items-center justify-center gap-2">
                                    <Link to="/admin/login" className="text-xs font-bold text-slate-400 hover:text-primary-600 uppercase tracking-[0.2em] flex items-center gap-2">
