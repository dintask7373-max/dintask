        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6">
                {[
                    ...
                    { label: 'Active Status', value: managers.filter(m => m.status === 'active').length?.toString(), icon: Users, color: 'text-emerald-600', bg: 'bg-emerald-100', border: 'border-emerald-100 dark:border-emerald-900', shadow: 'shadow-lg shadow-emerald-200/50 dark:shadow-none', gradient: 'bg-gradient-to-br from-white to-emerald-50 dark:from-slate-900 dark:to-emerald-900/20', trend: "Active" },
                    { label: 'Total Staff', value: allEmployees.filter(u => u.role !== 'admin').length?.toString(), icon: Briefcase, color: 'text-purple-600', bg: 'bg-purple-100', border: 'border-purple-100 dark:border-purple-900', shadow: 'shadow-lg shadow-purple-200/50 dark:shadow-none', gradient: 'bg-gradient-to-br from-white to-purple-50 dark:from-slate-900 dark:to-purple-900/20', trend: "Employees" },
