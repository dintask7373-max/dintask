...
import { UserPlus, Link2, Mail, Eye, EyeOff } from 'lucide-react';
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group/pass">
                                    <Input
                                        ...
                                        onChange={handleChange}
                                        className="h-12 px-5 bg-slate-50 border-slate-100 rounded-xl text-slate-900 font-medium text-sm placeholder:text-slate-300 focus:bg-white focus:ring-2 focus:ring-[#4461f2]/10 transition-all duration-200 pr-12"
                                    />
                                    <button
                                        type="button"
